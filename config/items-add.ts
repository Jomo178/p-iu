...
export type ItemsFormPropsValue = IssuesFormPropsValue | FramesFormPropsValue;
export type ItemsFormPropsValueKeys = keyof ItemsFormPropsValue;

export const useDefaultItemsFormValues = (itemType: `${EventType}`) => {
  return itemType === "issues"
    ? useLocalStorage("defaultIssueFormValues", {
        id: "1",
        name: "",
        group: "",
        act: "",
    ...
    : useLocalStorage("defaultFrameFormValues", {
        id: "1",
        name: "",
        code: "",
        codeDuplicate: false,
